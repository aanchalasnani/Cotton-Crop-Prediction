...
const Prediction = () => {
    ...
    const x = () => {
        ...
        setminmax([[1, 2000], [3000, 4], [1, 2000], [3, 4], [1, 2], [3, 4], [5, 6], [1, 5], [9, 0], [2, 9], [2, 8], [7, 9]]);
        //     }
        // } catch (error) {
        //     console.log(error);
        // }
    ...
    const sendDetail = async () => {
        ...
        // if (res.data) {
        // console.log(res.data);
        setBuffer([2000, 2000, 35000, 4500, 3300, 20, 3000, 40, 50, 5000, 4000, 20, 10, 23, 45, 56, 78, 23, 64, 72]);
